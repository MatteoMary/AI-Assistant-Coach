...
from app.api import user, metrics, training, plan, chat, strava, ai_coach, workout_context, plan_parser
...
app.include_router(strava.router, prefix=settings.API_V1_PREFIX + "/strava")
